...
<section class="hero-wrap js-fullheight">
  ...
  <div class="mouse">
    <a href="#" class="mouse-icon"><div class="mouse-wheel"><span class="ion-ios-arrow-round-down"></span></div></a>
  </div>
</section>
        ...
        <div class="row d-flex no-gutters">
            ...
            <div class="col-md-6 col-lg-6 pl-md-5 py-5">
              ...
              <div class="col-md-12 heading-section ftco-animate">
                ...
                <p>I am  Graduated in Software Engineering and now I'm a Backend Developer.</p>
                <ul class="about-info mt-4 px-md-0 px-2">
                    <li class="d-flex"><span>Name:</span> <span>Sepehr Karimi Seddigh</span></li>
                ...
                <div class="col-md-9">
                  <div id="page-1" class= "page one">
                    ...
                    <div class="resume-wrap d-flex ftco-animate">
                        ...
                        <div class="text pl-3">
                            ...
                            <span class="position">Darolfonoon School</span>
                            <p>Grade Point Average : 18</p>
                        </div>
                    </div>
                  </div>
                    ...
                    <div class="resume-wrap d-flex ftco-animate">
                        ...
                        <div class="text pl-3">
                            ...
                            <p>
                                ...
                                my main purpose is Entrepreneurship.
                            </p>
                        </div>
                    </div>
                    <div class="resume-wrap d-flex ftco-animate">
                        ...
                        <div class="text pl-3">
                            ...
                            <h2>Web Developer</h2>
                            <span class="position">Ecomiran</span>
                            <p>I was almost senior Backend Developer. we used YII2 framework and some other techniques.</p>
                        </div>
                    </div>                      
                    <div class="resume-wrap d-flex ftco-animate">
                        <div class="icon d-flex align-items-center justify-content-center">
                        ...
                        <div class="text pl-3">
                            ...
                            <span class="position">Bahar Samaneh</span>
                            <p>I was Junior Backend Developer. we used YII2 framework and some other techniques.</p>
                        </div>
                    </div>
                  </div>
                  <div id="page-3" class= "page three">
                    ...
                    <span class="progress-bar border-primary"></span>
                        ...
                        <div class="col-lg-4 mb-4">
                          <div class="bg-white rounded-lg shadow p-4">
                            <h2 class="h5 font-weight-bold text-center mb-4">YII2</h2>
...
<section class="ftco-section ftco-project" id="hobbies-section">
        ...
        <div class="row no-gutters justify-content-center pb-5">
            <div class="col-md-12 heading-section text-center ftco-animate">
                ...
                <p>
                    ...
                    I relax by watching movies / listening to musics / going for a walk / reading book / playing Backgammon , etc.</p>
            </div>
        </div>
        <div class="row no-gutters">
            <div class="col-md-4">
                <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(<?= Yii::$app->request->baseUrl . '/panel/images/work-1.jpg' ?>);">
                    <div class="overlay"></div>
                    <div class="text text-center p-4">
                        <h3><a href="#">My Favorite Movies And Serials</a></h3>
                        <span>
                            Interstellar/ Inception/ Lucy<br/>
                            Friends/ Mr Robot
                        </span>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(<?= Yii::$app->request->baseUrl . '/panel/images/work-2.jpg' ?>);">
                    <div class="overlay"></div>
                    <div class="text text-center p-4">
                        <h3><a href="#">My Favorite Singers</a></h3>
                        <span>Bahram Nouraei/ Ali Sorena</span>
                    </div>
                </div>
            </div>

            <div class="col-md-4">
                <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(<?= Yii::$app->request->baseUrl . '/panel/images/work-3.jpg' ?>);">
                    <div class="overlay"></div>
                    <div class="text text-center p-4">
            ...
            <div class="col-md-4">
                <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(<?= Yii::$app->request->baseUrl . '/panel/images/work-4.jpg' ?>);">
                    <div class="overlay"></div>
                    <div class="text text-center p-4">
                        <h3><a href="#">Real Friend</a></h3>
                        <span>The most loyal and trusted friend</span>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(<?= Yii::$app->request->baseUrl . '/panel/images/work-5.jpg' ?>);">
                    <div class="overlay"></div>
                    <div class="text text-center p-4">
            ...
            <div class="col-md-4">
                <div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(<?= Yii::$app->request->baseUrl . '/panel/images/work-6.jpg' ?>);">
                </div>
            </div>
        </div>
    </div>
